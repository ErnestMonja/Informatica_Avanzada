...
/**
 * La clase Receta modela una receta para preparar pociones magicas. Se la inicializa con un nombre a elección y 
 * en estado "ok" en falso y se deben agregar uno a uno los ingredientes que la conforman. Al terminar la carga,
 * se la establece con "ok" en verdadero.
...
public class Receta
{
    ...
    /**
     * El constructor debe inicializar el objeto con un nombre a eleccion y estado "ok" en falso.
    ...
    /**
     * Agrega un nuevo ingrediente a la receta. Solo se aceptaran nuevos ingredientes cuando la 
     ...
     * En caso contrario, no hace nada. No puede revertirse.
     * 
     ...
     * 
     * Debe generarse usando el nombre, "incompleta" o "completa" según
    ...
    {
        // TODO - Implementar metodo
        String info = "Receta " + this.getNombre() + " ";
        if(cerrada)
        {
            info += "(completa)\n";
        }
