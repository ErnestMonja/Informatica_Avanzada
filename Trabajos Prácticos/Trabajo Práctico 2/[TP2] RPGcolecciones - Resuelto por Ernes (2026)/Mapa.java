...
/**
 * Genera el mapa con habitaciones conectadas yobjetos en ellas.
 * 
 * Implementa el patron sigleton para evitar multiples instancias.
 */
public class Mapa
{
    ...
    /**
     * Este metodo devuelve el Mapa.  Si no se encuentra instanciado, se lo crea.
     * 
     ...
     * 
     * Se utiliza reflection para invocar los metodos en base al nombre de la habitacion.
     */
