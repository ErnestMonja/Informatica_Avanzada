...
public class Personaje 
{
    ...
    public void setBolsa(Bolsa bolsa) 
    {
        ...
        else if(this.bolsa.getPesoMaximo() < bolsa.getPesoMaximo())
        {
            for(Elemento elemento : this.bolsa.getElementosEnLaBolsa())
            {
                ...
                this.bolsa.delElemento(elemento.getNombre());
            }
            this.bolsa = bolsa;
        }
        else
    ...
    public void guardarElemento()
    {
        ...
        else if(this.bolsa.getPesoLibre() >= this.objeto.getPeso())
        {
    ...
    {
        Elemento encontrado = this.bolsa.delElemento(nombre);
        if(encontrado == null)
        {
    ...
    public void prepararReceta(Receta receta) 
    {
        ...
        for(Elemento elemento : this.bolsa.getElementosEnLaBolsa())
        {
            this.caldero.addIngrediente(this.bolsa.delElemento(elemento.getNombre()));
        }
        caldero.prepararPocima();
        Integer ingredientesFaltantes = this.caldero.getIngredientesFaltantes().size();
        
        if(ingredientesFaltantes != 0)
        {
            System.out.println("Faltan " + ingredientesFaltantes + " ingredientes para " + receta.getNombre());
        }
        // TODO - Implementar metodo
    }
