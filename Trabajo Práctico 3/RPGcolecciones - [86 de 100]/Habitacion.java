...
{
    protected TreeMap<Salida, Habitacion> salidas;  // almacena las salidas de esta habitacion
    protected TreeMap<String, Elemento> elementos;  // almacena los elementos portables y decorado de la habitacion
    private Liquido derramado;
    private EstadoContenedor estado;
    protected LugaresMapa lugar;                    // Esta version utiliza la informacion del enumerado LugaresMapa
    ...
    {
        salidas = new TreeMap<Salida, Habitacion>();
    ...
    public String getDescripcionLarga()
    {
        if(derramado!=null)
        {
            return getDescripcionCorta() +"\n"+"Se ha derramado "+derramado.getNombre()+ " en el piso"+"\n"+getStringDeSalidas ()+"\n"+getStringDeElementos();
        }
        else
        {
            return getDescripcionCorta() +"\n"+getStringDeSalidas ()+"\n"+getStringDeElementos();
 ...
 */ 
    ...
    private class ConElementos extends EstadoContenedor
    {
        ...
        public Elemento getElemento(String nombre) throws ContenedorVacioException, AccionNoPermitidaException
        {
            ...
            if(elementos.get(nombre) instanceof Portable)
            {
                if(elementos.size()==1)
                {
                    estado= new Vacia();
